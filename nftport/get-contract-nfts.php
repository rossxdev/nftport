...
<body>
	...
	<div class="container">
		<div class="p-4 text-center rounded-3 bg-white mt-4 mb-4">
			...
			<p>get-contract-nfts</p>
		</div>
	</div>
	<div class="container">
		<form method="POST" action="get-contract-nfts-handle.php" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="contract-address">Contract Address</label>
				<input type="text" name="contract_address" class="form-control" id="contract-address" value="<?=$_GET['contract_address'];?>">
			</div>
			<div class="mb-3">
